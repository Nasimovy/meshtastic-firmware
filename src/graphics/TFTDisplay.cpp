    ...
    {
        {
            ...
            cfg.spi_mode = 0;
            cfg.freq_write = 40000000; // SPI clock for transmission (up to 80MHz, rounded to the value obtained by dividing
                                       // 80MHz by an integer)
        ...
        {                                        // Set the display panel control.
            ...
            cfg.panel_width = TFT_WIDTH;                  // actual displayable width
            cfg.panel_height = TFT_HEIGHT;                // actual displayable height
            cfg.offset_x = 49;                            // Panel offset amount in X direction
...
static LGFX *tft = nullptr;
    ...
    defined(RAK14014) || defined(HX8357_CS) || defined(ILI9488_CS) || defined(ST72xx_DE) || defined(ST7796_CS) ||                \
