...
static void drawNodes(OLEDDisplay *display, int16_t x, int16_t y, const NodeStatus *nodeStatus)
{
    ...
    snprintf(usersString, sizeof(usersString), "%d/%d", nodeStatus->getNumOnline(), nodeStatus->getNumTotal());
     ...
     defined(ST7789_CS) || defined(USE_ST7789) || defined(ST7796_CS) || defined(HX8357_CS)) &&                                   \
    ...
    : concurrency::OSThread("Screen"), address_found(address), model(screenType), geometry(geometry), cmdQueue(32)
{
    ...
    defined(RAK14014) || defined(HX8357_CS) || defined(ST7796_CS)
...
void Screen::setup()
{
    ...
    defined(ST7789_CS) || defined(RAK14014) || defined(HX8357_CS) || defined(ST7796_CS)
...
#if (defined(USE_EINK) || defined(ILI9341_DRIVER) || defined(ILI9342_DRIVER) || defined(ST7701_CS) || defined(ST7735_CS) ||      \
     defined(ST7789_CS) || defined(USE_ST7789) || defined(HX8357_CS) || defined(ST7796_CS) || ARCH_PORTDUINO) &&                 \
    !defined(DISPLAY_FORCE_SMALL_FONTS)
